...
void postNoteAboutKexts( CFStringRef __unused theNotificationCenterName,
                         CFMutableDictionaryRef __unused theDict )
{    
...
void postNoteAboutKextLoadsMT(CFStringRef __unused theNotificationCenterName,
                              CFMutableArrayRef __unused theKextPathArray)
{
