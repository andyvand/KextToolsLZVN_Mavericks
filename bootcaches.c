...
int
copyCSFDEInfo(CFStringRef __unused uuidStr, CFDictionaryRef * __unused econtext,
               time_t * __unused timeStamp)
{
    int             rval = ELAST+1;
...
int
writeCSFDEProps(int __unused scopefd, CFDictionaryRef __unused ectx,
                char * __unused cspvbsd, char * __unused dstpath)
{
...
void
_writeResource(const void * __unused value, void *ctxp)
{
    int bsderr;
